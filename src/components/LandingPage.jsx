  ...
  return (
    <div className="flex justify-between h-[89vh] background  bg-cover bg-no-repeat"  style={{
      ...
      <div className="w-1/2 flex flex-col justify-center bg-black bg-opacity-70 text-start">
           <h1 className="text-6xl font-bold mb-5 text-white mt-20 pl-16">PHOTOGRAPHY</h1>
           <h1 className="text-5xl font-bold mb-10 text-orange-400 pl-16">STUDIO</h1>
           <h6 className="text-3xl font-medium  text-white  pl-16 pb-6">For All Services</h6>
           <p className=" text-gray-400 ml-16 text-lg">
         ...
         <div className="flex justify-between mt-20 ml-16">
